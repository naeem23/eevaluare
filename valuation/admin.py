...
admin.site.register(ValuatedProperty)
admin.site.register(CompartimentareValue)
admin.site.register(CustomFieldValue)
admin.site.register(Photo)
admin.site.register(ValuationSummary)
admin.site.register(SummaryValue)
admin.site.register(Construction)
admin.site.register(Suprafete)
admin.site.register(SourceofInformation)
admin.site.register(PresentationData)
admin.site.register(MarketAnalysis)
admin.site.register(ComparableProperty)
admin.site.register(ComparableTable)
admin.site.register(MvbTable)
admin.site.register(PropertyFiles)