# Generated by Django 3.2.6 on 2021-10-18 13:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('suprateran_mv', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('subteran_mv', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('boxa_mv', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('aiav', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('suprateran_iv', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('subteran_iv', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('boxa_iv', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ...
                ('approach', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='valuation.valuationapproach')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invelitoare', models.CharField(blank=True, choices=[('bitum', 'Bitum'), ('tigla', 'Tigla'), ('tabla', 'Tabla')], max_length=255, null=True)),
                ...
                ('heating', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='valuation.heatingsystem')),
                ('ref_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='valuation.valuatedproperty')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('floor_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='valuation.floortype')),
                ('ref_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='valuation.valuatedproperty')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ad', models.CharField(blank=True, choices=[('oferta', 'Oferta'), ('tranzactie', 'Tranzactie')], max_length=55, null=True)),
                ('fc', models.CharField(blank=True, choices=[('normale', 'Normale')], max_length=55, null=True)),
                ('sc', models.CharField(blank=True, choices=[('independente', 'Independente')], max_length=55, null=True)),
                ...
                ('cp', models.CharField(blank=True, choices=[('', 'Alege'), ('decomandat', 'Decomandat'), ('semidecomandat', 'Semidecomandat'), ('nedecomandat', 'Neecomandat'), ('circular', 'Circular')], max_length=55, null=True)),
                ...
                ('opt1_val', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('finish', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='valuation.finishtype')),
                ('hs', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='valuation.heatingsystem')),
                ('mobila', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='valuation.mobilatype')),
                ('pr', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='valuation.propertyrighttype')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file1', models.FileField(blank=True, upload_to='anexa/%Y/%m/%d')),
                ('file2', models.FileField(blank=True, upload_to='comparabile_utilizate/%Y/%m/%d')),
                ('ref_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='valuation.valuatedproperty')),
            ],
        ),
        migrations.CreateModel(
